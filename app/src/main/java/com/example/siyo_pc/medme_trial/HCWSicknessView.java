...
public class HCWSicknessView extends AppCompatActivity implements AsyncTaskResponse, AsyncTaskResponse2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hcwsickness_view);
        ...
        if (userLoggedIn == null) {
            ...
            sicknessTitle = (TextView)findViewById(R.id.tvHCWSicknessTitle);
            sicknessDesc = (TextView)findViewById(R.id.tvHCWSicknessDescription);
            sicknessGreekName = (TextView)findViewById(R.id.tvHCWSicknessGreekName);
            listDiseases = (ListView) findViewById(R.id.listHCWViewRelatedDiseases);
            listSymptoms = (ListView) findViewById(R.id.listHCWViewRelatedSymptoms);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, HCWSicknessesViewAll.class);
