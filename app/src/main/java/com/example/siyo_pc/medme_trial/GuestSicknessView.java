...
public class GuestSicknessView extends AppCompatActivity implements AsyncTaskResponse, AsyncTaskResponse2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userLoggedIn == null) {
            ...
            sicknessTitle = (TextView)findViewById(R.id.tvGuestSicknessTitle);
            sicknessDesc = (TextView)findViewById(R.id.tvGuestSicknessDescription);
            sicknessGreekName = (TextView)findViewById(R.id.tvGuestSicknessGreekName);
            listDiseases = (ListView) findViewById(R.id.listGuestViewRelatedDiseases);
            listSymptoms = (ListView) findViewById(R.id.listGuestViewRelatedSymptoms);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, GuestSicknessesViewAll.class);
    ...
    private void fillDiseaseList(ArrayList<MM_Disease> diseaseList){
        ...
        if (diseaseList != null) {
            DiseaseAdapter adapter = new DiseaseAdapter(this, diseaseList, userLoggedIn);
    ...
    private void fillSymptomList(ArrayList<MM_Symptom> symptomList){
        ...
        if (symptomList != null) {
            SymptomAdapter adapter = new SymptomAdapter(this, symptomList, userLoggedIn);
            View header = getLayoutInflater().inflate(R.layout.listview_header_row, null);
