...
public class AsyncGetAllSicknessesForDisease extends AsyncTask<Void, Void, List<JSONObject>> {
    ...
    public AsyncGetAllSicknessesForDisease(AsyncTaskResponse callBack, Context context, ArrayList<NameValuePair> params) {
        this.callBack = callBack;
        this.url = "http://ssimayi-medme.co.za/getAllSicknessesForDisease.php";
