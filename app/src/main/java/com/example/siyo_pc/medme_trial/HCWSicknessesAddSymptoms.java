...
public class HCWSicknessesAddSymptoms extends AppCompatActivity implements AsyncTaskResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hcwsicknesses_add_symptoms);
        ...
        if (userLoggedIn == null) {
            ...
            linSymptoms = (LinearLayout)findViewById(R.id.linHCWSicknessSymptomsAdd);
            btnAdd = (Button) findViewById(R.id.btnHCWSicknessSymptomAdd);
            btnBack = (Button) findViewById(R.id.btnHCWSicknessSymptomBack);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, HCWSicknessesAdd.class);
        ...
        if (diseaseChosen != null) {
            if (sicknessSaved != null) {
                if (symptomToAddList != null && symptomToAddList.size() > 0) {
                    ...
                    bll.addSicknessHCW (sicknessSaved, diseaseChosen, symptomToAddList);
                } else {
