...
public class GuestDiseaseView extends AppCompatActivity implements AsyncTaskResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userLoggedIn == null) {
            ...
            diseaseTitle = (TextView)findViewById(R.id.tvGuestDiseaseTitle);
            diseaseGreekName = (TextView)findViewById(R.id.tvGuestDiseaseGreekName);
            diseaseDesc = (TextView)findViewById(R.id.tvGuestDiseaseDescription);
    ...
    private void getSicknessInformation(ArrayList<MM_Sickness> sicknessList) {
        if (sicknessList != null) {
            SicknessAdapter adapter = new SicknessAdapter(this, sicknessList, userLoggedIn);
            listSicknesses = (ListView) findViewById(R.id.listViewGuestSicknessDiseaseLink);
