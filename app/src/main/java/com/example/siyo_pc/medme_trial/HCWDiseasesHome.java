...
public class HCWDiseasesHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hcwdiseases_home);
        ...
        if (userLoggedIn == null) {
            ...
            btnAdd = (Button)findViewById(R.id.btnHCWAdd);
            btnViewAll = (Button)findViewById(R.id.btnHCWViewAll);
    ...
    private void addButtonEvents() {
        addNextActivityOnClickListener(btnAdd, HCWDiseasesAdd.class);
        addNextActivityOnClickListener(btnViewAll, HCWDiseasesViewAll.class);
    }
