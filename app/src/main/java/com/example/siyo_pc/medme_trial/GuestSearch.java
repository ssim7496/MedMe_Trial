...
public class GuestSearch extends AppCompatActivity implements AsyncSearchResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userLoggedIn == null) {
            ...
            btnGuestSearch = (Button)findViewById(R.id.btnGuestSearch);
            edtGuestSearchText = (EditText)findViewById(R.id.edtGuestSearchText);
            listSearchResults = (ListView)findViewById(R.id.listViewGuestSearchResults);
