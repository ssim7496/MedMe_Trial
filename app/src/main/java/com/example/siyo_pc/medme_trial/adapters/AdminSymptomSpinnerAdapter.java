...
public class AdminSymptomSpinnerAdapter extends ArrayAdapter<MM_Symptom>{

    Context context;
    int resource;
    ArrayList<MM_Symptom> data = null;

    public AdminSymptomSpinnerAdapter(Context context, int resource, ArrayList<MM_Symptom> data) {
