...
public class AsyncGetAllSicknesses extends AsyncTask<Void, Void, List<JSONObject>> {
    ...
    public AsyncGetAllSicknesses(AsyncTaskResponse callBack, Context context) {
        this.callBack = callBack;
        this.url = "http://ssimayi-medme.co.za/getAllSicknesses.php";
