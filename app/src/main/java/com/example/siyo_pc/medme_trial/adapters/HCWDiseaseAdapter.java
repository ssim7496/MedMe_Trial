...
import com.example.siyo_pc.medme_trial.HCWDiseaseView;
...
public class HCWDiseaseAdapter extends ArrayAdapter<MM_Disease> {

    private Context context;
    ArrayList<MM_Disease> data = null;
    MM_Person userLoggedIn = null;

    public HCWDiseaseAdapter(Context context, ArrayList<MM_Disease> data, MM_Person userLoggedIn) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvName.setOnClickListener(new TextView.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, HCWDiseaseView.class);
