...
public class GuestDiseasesViewAll extends AppCompatActivity implements AsyncTaskResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_diseases_view_all);
        ...
        if (userLoggedIn == null) {
            ...
            listDiseases = (ListView) findViewById(R.id.listViewGuestDiseases);
