...
public class SicknessSymptomSpinnerAdapter extends ArrayAdapter<MM_Symptom>{

    Context context;
    int resource;
    ArrayList<MM_Symptom> data = null;

    public SicknessSymptomSpinnerAdapter(Context context, int resource, ArrayList<MM_Symptom> data) {
