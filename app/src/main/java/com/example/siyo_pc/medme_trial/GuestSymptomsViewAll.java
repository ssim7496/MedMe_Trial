...
public class GuestSymptomsViewAll extends AppCompatActivity implements AsyncTaskResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_symptoms_view_all);
        ...
        if (userLoggedIn == null) {
            ...
            listSymptoms = (ListView) findViewById(R.id.listViewGuestSymptoms);
