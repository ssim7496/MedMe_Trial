...
public class GuestDiagnose extends AppCompatActivity implements AsyncTaskResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_diagnose);
        ...
        btnDiagnose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkedSymptoms.size() > 0) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), GuestDiagnosisSymptomsConfirm.class);
