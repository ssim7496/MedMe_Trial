...
public class AsyncGetAllSicknessesForSymptom extends AsyncTask<Void, Void, List<JSONObject>> {
    ...
    public AsyncGetAllSicknessesForSymptom(AsyncTaskResponse callBack, Context context, ArrayList<NameValuePair> params) {
        this.callBack = callBack;
        this.url = "http://ssimayi-medme.co.za/getAllSicknessesForSymptom.php";
    ...
    protected void onPostExecute(List<JSONObject> result) {
        ...
        callBack.onTaskCompleted(result, 3);
