...
public class AsyncGetAllDiseases extends AsyncTask<Void, Void, List<JSONObject>> {
    ...
    public AsyncGetAllDiseases(AsyncTaskResponse callBack, Context context) {
        this.callBack = callBack;
        this.url = "http://ssimayi-medme.co.za/getAllDiseases.php";
