...
import com.example.siyo_pc.medme_trial.HCWSymptomView;
...
public class HCWSymptomAdapter extends ArrayAdapter<MM_Symptom> {

    private Context context;
    ArrayList<MM_Symptom> data = null;
    MM_Person userLoggedIn = null;

    public HCWSymptomAdapter(Context context, ArrayList<MM_Symptom> data, MM_Person userLoggedIn) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvName.setOnClickListener(new TextView.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, HCWSymptomView.class);
