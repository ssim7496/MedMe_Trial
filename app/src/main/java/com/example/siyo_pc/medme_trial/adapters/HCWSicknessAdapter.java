...
public class HCWSicknessAdapter extends ArrayAdapter<MM_Sickness> {

    private Context context;
    ArrayList<MM_Sickness> data = null;
    MM_Person userLoggedIn = null;

    public HCWSicknessAdapter(Context context, ArrayList<MM_Sickness> data, MM_Person userLogged) {
