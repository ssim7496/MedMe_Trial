...
public class GuestSymptomView extends AppCompatActivity implements AsyncTaskResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userLoggedIn == null) {
            ...
            symptomTitle = (TextView) findViewById(R.id.tvGuestSymptomTitle);
            symptomDesc = (TextView) findViewById(R.id.tvGuestSymptomDescription);
            symptomGreekName = (TextView) findViewById(R.id.tvGuestSymptomGreekName);
    ...
    private void getSicknessInformation(ArrayList<MM_Sickness> sicknessList) {
        if (sicknessList != null) {
            ...
            listSickness = (ListView) findViewById(R.id.listViewGuestSicknessSymptomLink);
