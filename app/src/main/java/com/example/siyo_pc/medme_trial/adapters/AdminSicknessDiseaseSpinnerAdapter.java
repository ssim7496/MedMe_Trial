...
public class AdminSicknessDiseaseSpinnerAdapter extends ArrayAdapter<MM_Disease>{

    Context context;
    int resource;
    ArrayList<MM_Disease> data = null;

    public AdminSicknessDiseaseSpinnerAdapter(Context context, int resource, ArrayList<MM_Disease> data) {
