...
public class GuestDiagnosedSicknessAdapter extends ArrayAdapter<MM_Sickness> {
    ...
    public GuestDiagnosedSicknessAdapter(Context context, ArrayList<MM_Sickness> data, MM_Person userLogged, ArrayList<MM_DiagnosedSymptoms> symptomData) {
