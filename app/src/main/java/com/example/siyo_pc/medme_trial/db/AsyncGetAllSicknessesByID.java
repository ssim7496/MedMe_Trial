...
public class AsyncGetAllSicknessesByID extends AsyncTask<Void, Void, List<JSONObject>> {
    ...
    public AsyncGetAllSicknessesByID(AsyncTaskResponse callBack, Context context, ArrayList<NameValuePair> params) {
        this.callBack = callBack;
        this.url = "http://ssimayi-medme.co.za/getAllSicknessesBySicknessID.php";
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage("Getting sickness information");
    ...
    protected void onPostExecute(List<JSONObject> result) {
        ...
        callBack.onTaskCompleted(result, 11);
    }
}